  ...
  return (
    <>
      ...
      {showUpgradeModal && (
        ...
        >
          <div
            className="bg-white rounded-lg shadow-xl w-[600px]  h-[440px] overflow-hidden relative"
          ...
          >
            ...
            <div className="p-6 flex flex-col items-center">
              ...
              <p className="text-center text-gray-600 mb-2">
                The Signals feature is not included in the 'Free' plan.
              </p>
              <p className="text-center text-gray-600 mb-4">
                Upgrade to the 'Express' plan to access advanced features like this.
              </p>
